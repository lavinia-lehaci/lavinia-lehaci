...
A software engineer from Romania with a Master's degree in Computer Science, having studied and worked across Denmark, Austria, Spain, and Bulgaria. <br/>
4+ years of experience, currently focusing on C# and .NET.

Some of the technologies I've worked with in the past:
[![My Skills](https://skillicons.dev/icons?i=cs,cpp,java,python,js,html,css,dotnet,spring,postgres,unity,visualstudio,vscode,git&theme=dark)](https://skillicons.dev)
